...
**Note** Only node 8 (and electron 2) are supported at the momement. This is because `deltachat-core` comes bundled with `openssl@1.0.17` which is incompatible with node 10.
...
| [`DC_EVENT_FILE_COPIED`](https://deltachat.github.io/api/group__DC__EVENT.html#ga89c075d9f7d74b0561b18132ee33ab3d)  | A file has been copied    | `(fileName)`  |
